                        ...
                        <div class="col-sm">
                            <form>
                                <div class="form-group text-center pt-4">
                                    <span> Filter op tekst</span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Filter op tekst</label>
                                    <input type="email"
                                           class="form-control"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Filter op project</label>
                                    <input type="password"
                                           class="form-control"
                                ...
                                <!-- list check -->
                                <div class="checkbox-list-right border rounded form-group">
