...
$a = DB::queryOneRow("select a.question_id,a.question_title,a.question_project_id,b.project_title,b.project_date_letter from question a left join project b on b.project_id=a.question_project_id where a.question_id=$id");//#查询问题和对应的project
?>
<!DOCTYPE html>
<html>
...
<body class="page_search_engine">
	...
	<div class="card m-3 p-md-3 p-lg-4 text-center">
        ...
        <div class="project-info">
           ...
           <div class="row justify-content-md-center">
                <div class="col-sm col-md-6 col-lg-4">
                    ...
                    <a href="overzicht-detail-keyword.php?id=<?=$a['question_project_id']?>"
        ...
        <div class="project-table mt-3">
            <button type="button" onclick="location.href='search_engine.html'"
